...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'Hdm1wysS4oZgvY2K'); // Random key for encryption
...
$PROJECT_ID = "{93991896-96CF-4745-A486-919A3152DDBF}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "predictor", "qs" => "`", "qe" => "`");
