 ...
 */
class news_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		// News_Name
		$this->News_Name = new ReportField('news_base', 'news', 'x_News_Name', 'News_Name', '`News_Name`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->News_Name->Sortable = TRUE; // Allow sort
		$this->News_Name->DateFilter = "";
		$this->fields['News_Name'] = &$this->News_Name;

		// Date
		$this->Date = new ReportField('news_base', 'news', 'x_Date', 'Date', '`Date`', 133, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Content
		$this->Content = new ReportField('news_base', 'news', 'x_Content', 'Content', '`Content`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Content->Sortable = TRUE; // Allow sort
		$this->Content->DateFilter = "";
