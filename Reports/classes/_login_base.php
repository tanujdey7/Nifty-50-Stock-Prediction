 ...
 */
class _login_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		// User_ID
		$this->User_ID = new ReportField('_login_base', 'login', 'x_User_ID', 'User_ID', '`User_ID`', 3, -1, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Username
		$this->Username = new ReportField('_login_base', 'login', 'x_Username', 'Username', '`Username`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Username->Sortable = TRUE; // Allow sort
		$this->Username->DateFilter = "";
		$this->fields['Username'] = &$this->Username;

		// Email
		$this->_Email = new ReportField('_login_base', 'login', 'x__Email', 'Email', '`Email`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_Email->Sortable = TRUE; // Allow sort
		$this->_Email->DateFilter = "";
		$this->fields['Email'] = &$this->_Email;

		// Password
		$this->Password = new ReportField('_login_base', 'login', 'x_Password', 'Password', '`Password`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`login`";
	}
