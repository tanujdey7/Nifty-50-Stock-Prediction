...
/**
 * Page class (s_c_details_rpt)
 */
class s_c_details_rpt extends s_c_details_base
{
	...
	// Project ID
	public $ProjectID = "{93991896-96CF-4745-A486-919A3152DDBF}";

	// Page object name
	public $PageObjName = 's_c_details_rpt';
	public $Token = "";
	...
	public function __construct()
	{
		...
		// Table object (s_c_details_base)
		if (!isset($GLOBALS["s_c_details_base"])) {
			$GLOBALS["s_c_details_base"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["s_c_details_base"];
		}
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 's_c_details');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fs_c_detailsrpt";
	...
	protected function setupExportOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fs_c_detailsrpt\" href=\"#\">" . $ReportLanguage->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fs_c_detailsrpt\" href=\"#\">" . $ReportLanguage->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $ReportLanguage->phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fs_c_detailsrpt\">" . $ReportLanguage->phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	public function run()
	{
		...
		$this->Comp_ID->setVisibility();
		$this->Comp_Name->setVisibility();
		$this->Comp_Website->setVisibility();
		$this->Headquaters->setVisibility();
		$this->Founded->setVisibility();
		$this->Industry->setVisibility();
		$this->Symbol->setVisibility();
		$this->Series->setVisibility();
		$this->ISIN_Code->setVisibility();
	...
	public function loadRowValues($firstRow = FALSE)
	{
		...
		if ($firstRow) { // Get first row
				$this->FirstRowData = [];
				$this->FirstRowData["Comp_ID"] = $this->Recordset->fields('Comp_ID');
				$this->FirstRowData["Comp_Name"] = $this->Recordset->fields('Comp_Name');
				$this->FirstRowData["Comp_Website"] = $this->Recordset->fields('Comp_Website');
				$this->FirstRowData["Headquaters"] = $this->Recordset->fields('Headquaters');
				$this->FirstRowData["Founded"] = $this->Recordset->fields('Founded');
				$this->FirstRowData["Industry"] = $this->Recordset->fields('Industry');
				$this->FirstRowData["Symbol"] = $this->Recordset->fields('Symbol');
				$this->FirstRowData["Series"] = $this->Recordset->fields('Series');
				$this->FirstRowData["ISIN_Code"] = $this->Recordset->fields('ISIN_Code');
				$this->FirstRowData["Img"] = $this->Recordset->fields('Img');
		} else { // Get next row
			$this->Recordset->moveNext();
		}
		if (!$this->Recordset->EOF) {
			$this->Comp_ID->setDbValue($this->Recordset->fields('Comp_ID'));
			$this->Comp_Name->setDbValue($this->Recordset->fields('Comp_Name'));
			$this->Comp_Website->setDbValue($this->Recordset->fields('Comp_Website'));
			$this->Headquaters->setDbValue($this->Recordset->fields('Headquaters'));
			$this->Founded->setDbValue($this->Recordset->fields('Founded'));
			$this->Industry->setDbValue($this->Recordset->fields('Industry'));
			$this->Symbol->setDbValue($this->Recordset->fields('Symbol'));
			$this->Series->setDbValue($this->Recordset->fields('Series'));
			$this->ISIN_Code->setDbValue($this->Recordset->fields('ISIN_Code'));
			$this->Img->setDbValue($this->Recordset->fields('Img'));
			$this->Values[1] = $this->Comp_ID->CurrentValue;
			$this->Values[2] = $this->Comp_Name->CurrentValue;
			$this->Values[3] = $this->Comp_Website->CurrentValue;
			$this->Values[4] = $this->Headquaters->CurrentValue;
			$this->Values[5] = $this->Founded->CurrentValue;
			$this->Values[6] = $this->Industry->CurrentValue;
			$this->Values[7] = $this->Symbol->CurrentValue;
			$this->Values[8] = $this->Series->CurrentValue;
			$this->Values[9] = $this->ISIN_Code->CurrentValue;
			$this->Values[10] = $this->Img->CurrentValue;
		} else {
			$this->Comp_ID->setDbValue("");
			$this->Comp_Name->setDbValue("");
			$this->Comp_Website->setDbValue("");
			$this->Headquaters->setDbValue("");
			$this->Founded->setDbValue("");
			$this->Industry->setDbValue("");
			$this->Symbol->setDbValue("");
			$this->Series->setDbValue("");
			$this->ISIN_Code->setDbValue("");
			$this->Img->setDbValue("");
		}
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_SEARCH) { // Search row
			...
			// Comp_Website
			$this->Comp_Website->HrefValue = "";

			// Headquaters
			$this->Headquaters->HrefValue = "";

			// Founded
			$this->Founded->HrefValue = "";
			...
			$this->Comp_ID->CellAttrs["class"] = ($this->RecordCount % 2 <> 1 ? "ew-table-alt-row" : "ew-table-row");

			// Comp_Name
			$this->Comp_Name->ViewValue = $this->Comp_Name->CurrentValue;
			$this->Comp_Name->CellAttrs["class"] = ($this->RecordCount % 2 <> 1 ? "ew-table-alt-row" : "ew-table-row");

			// Comp_Website
			$this->Comp_Website->ViewValue = $this->Comp_Website->CurrentValue;
			$this->Comp_Website->CellAttrs["class"] = ($this->RecordCount % 2 <> 1 ? "ew-table-alt-row" : "ew-table-row");

			// Headquaters
			$this->Headquaters->ViewValue = $this->Headquaters->CurrentValue;
			$this->Headquaters->CellAttrs["class"] = ($this->RecordCount % 2 <> 1 ? "ew-table-alt-row" : "ew-table-row");

			// Founded
			$this->Founded->ViewValue = $this->Founded->CurrentValue;
			$this->Founded->ViewValue = FormatNumber($this->Founded->ViewValue, 0, -2, -2, -2);
			$this->Founded->CellAttrs["class"] = ($this->RecordCount % 2 <> 1 ? "ew-table-alt-row" : "ew-table-row");

			// Industry
			$this->Industry->ViewValue = $this->Industry->CurrentValue;
			$this->Industry->CellAttrs["class"] = ($this->RecordCount % 2 <> 1 ? "ew-table-alt-row" : "ew-table-row");

			// Symbol
			$this->Symbol->ViewValue = $this->Symbol->CurrentValue;
			$this->Symbol->CellAttrs["class"] = ($this->RecordCount % 2 <> 1 ? "ew-table-alt-row" : "ew-table-row");

			// Series
			$this->Series->ViewValue = $this->Series->CurrentValue;
			$this->Series->CellAttrs["class"] = ($this->RecordCount % 2 <> 1 ? "ew-table-alt-row" : "ew-table-row");

			// ISIN_Code
			$this->ISIN_Code->ViewValue = $this->ISIN_Code->CurrentValue;
			$this->ISIN_Code->CellAttrs["class"] = ($this->RecordCount % 2 <> 1 ? "ew-table-alt-row" : "ew-table-row");

			// Img
			$this->Img->ViewValue = $this->Img->CurrentValue;
			$this->Img->CellAttrs["class"] = ($this->RecordCount % 2 <> 1 ? "ew-table-alt-row" : "ew-table-row");
		...
		if ($this->RowType == ROWTYPE_TOTAL) { // Summary row
			...
			// Comp_ID
			$currentValue = $this->Comp_ID->CurrentValue;
			$viewValue = &$this->Comp_ID->ViewValue;
			$viewAttrs = &$this->Comp_ID->ViewAttrs;
			$cellAttrs = &$this->Comp_ID->CellAttrs;
			$hrefValue = &$this->Comp_ID->HrefValue;
			$linkAttrs = &$this->Comp_ID->LinkAttrs;
			$this->Cell_Rendered($this->Comp_ID, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

			// Comp_Name
			$currentValue = $this->Comp_Name->CurrentValue;
			$viewValue = &$this->Comp_Name->ViewValue;
			$viewAttrs = &$this->Comp_Name->ViewAttrs;
			$cellAttrs = &$this->Comp_Name->CellAttrs;
			$hrefValue = &$this->Comp_Name->HrefValue;
			$linkAttrs = &$this->Comp_Name->LinkAttrs;
			$this->Cell_Rendered($this->Comp_Name, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

			// Comp_Website
			$currentValue = $this->Comp_Website->CurrentValue;
			$viewValue = &$this->Comp_Website->ViewValue;
			$viewAttrs = &$this->Comp_Website->ViewAttrs;
			$cellAttrs = &$this->Comp_Website->CellAttrs;
			$hrefValue = &$this->Comp_Website->HrefValue;
			$linkAttrs = &$this->Comp_Website->LinkAttrs;
			$this->Cell_Rendered($this->Comp_Website, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

			// Headquaters
			$currentValue = $this->Headquaters->CurrentValue;
			$viewValue = &$this->Headquaters->ViewValue;
			$viewAttrs = &$this->Headquaters->ViewAttrs;
			$cellAttrs = &$this->Headquaters->CellAttrs;
			$hrefValue = &$this->Headquaters->HrefValue;
			$linkAttrs = &$this->Headquaters->LinkAttrs;
			$this->Cell_Rendered($this->Headquaters, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

			// Founded
			$currentValue = $this->Founded->CurrentValue;
			$viewValue = &$this->Founded->ViewValue;
			$viewAttrs = &$this->Founded->ViewAttrs;
			$cellAttrs = &$this->Founded->CellAttrs;
			$hrefValue = &$this->Founded->HrefValue;
			$linkAttrs = &$this->Founded->LinkAttrs;
			$this->Cell_Rendered($this->Founded, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
			...
			// Symbol
			$currentValue = $this->Symbol->CurrentValue;
			$viewValue = &$this->Symbol->ViewValue;
			$viewAttrs = &$this->Symbol->ViewAttrs;
			$cellAttrs = &$this->Symbol->CellAttrs;
			$hrefValue = &$this->Symbol->HrefValue;
			$linkAttrs = &$this->Symbol->LinkAttrs;
			$this->Cell_Rendered($this->Symbol, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

			// Series
			$currentValue = $this->Series->CurrentValue;
			$viewValue = &$this->Series->ViewValue;
			$viewAttrs = &$this->Series->ViewAttrs;
			$cellAttrs = &$this->Series->CellAttrs;
			$hrefValue = &$this->Series->HrefValue;
			$linkAttrs = &$this->Series->LinkAttrs;
			$this->Cell_Rendered($this->Series, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

			// ISIN_Code
			$currentValue = $this->ISIN_Code->CurrentValue;
			$viewValue = &$this->ISIN_Code->ViewValue;
			$viewAttrs = &$this->ISIN_Code->ViewAttrs;
			$cellAttrs = &$this->ISIN_Code->CellAttrs;
			$hrefValue = &$this->ISIN_Code->HrefValue;
			$linkAttrs = &$this->ISIN_Code->LinkAttrs;
			$this->Cell_Rendered($this->ISIN_Code, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

			// Img
			$currentValue = $this->Img->CurrentValue;
			$viewValue = &$this->Img->ViewValue;
			$viewAttrs = &$this->Img->ViewAttrs;
			$cellAttrs = &$this->Img->CellAttrs;
			$hrefValue = &$this->Img->HrefValue;
			$linkAttrs = &$this->Img->LinkAttrs;
			$this->Cell_Rendered($this->Img, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
		}
	...
	protected function setupFieldCount()
	{
		...
		if ($this->Comp_ID->Visible)
			$this->DetailColumnCount += 1;
		if ($this->Comp_Name->Visible)
			$this->DetailColumnCount += 1;
		if ($this->Comp_Website->Visible)
			$this->DetailColumnCount += 1;
		if ($this->Headquaters->Visible)
			$this->DetailColumnCount += 1;
		if ($this->Founded->Visible)
			$this->DetailColumnCount += 1;
		if ($this->Industry->Visible)
			$this->DetailColumnCount += 1;
		if ($this->Symbol->Visible)
			$this->DetailColumnCount += 1;
		if ($this->Series->Visible)
			$this->DetailColumnCount += 1;
		if ($this->ISIN_Code->Visible)
			$this->DetailColumnCount += 1;
		if ($this->Img->Visible)
			$this->DetailColumnCount += 1;
	}
	...
	protected function getSort()
	{
		...
		if ($resetSort) {
			...
			$this->Comp_ID->setSort("");
			$this->Comp_Name->setSort("");
			$this->Comp_Website->setSort("");
			$this->Headquaters->setSort("");
			$this->Founded->setSort("");
			$this->Industry->setSort("");
			$this->Symbol->setSort("");
			$this->Series->setSort("");
			$this->ISIN_Code->setSort("");
			$this->Img->setSort("");
