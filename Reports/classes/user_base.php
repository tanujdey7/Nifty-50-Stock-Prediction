 ...
 */
class user_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		// User_ID
		$this->User_ID = new ReportField('user_base', 'user', 'x_User_ID', 'User_ID', '`User_ID`', 3, -1, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// First_Name
		$this->First_Name = new ReportField('user_base', 'user', 'x_First_Name', 'First_Name', '`First_Name`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->First_Name->Sortable = TRUE; // Allow sort
		$this->First_Name->DateFilter = "";
		$this->fields['First_Name'] = &$this->First_Name;

		// Last_Name
		$this->Last_Name = new ReportField('user_base', 'user', 'x_Last_Name', 'Last_Name', '`Last_Name`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Last_Name->Sortable = TRUE; // Allow sort
		$this->Last_Name->DateFilter = "";
		$this->fields['Last_Name'] = &$this->Last_Name;

		// Age
		$this->Age = new ReportField('user_base', 'user', 'x_Age', 'Age', '`Age`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Age->Sortable = TRUE; // Allow sort
		$this->Age->DefaultErrorMessage = $ReportLanguage->phrase("IncorrectInteger");
		$this->Age->DateFilter = "";
		$this->fields['Age'] = &$this->Age;

		// Email
		$this->_Email = new ReportField('user_base', 'user', 'x__Email', 'Email', '`Email`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_Email->Sortable = TRUE; // Allow sort
		$this->_Email->DateFilter = "";
		$this->fields['Email'] = &$this->_Email;

		// Username
		$this->Username = new ReportField('user_base', 'user', 'x_Username', 'Username', '`Username`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Username->Sortable = TRUE; // Allow sort
		$this->Username->DateFilter = "";
		$this->fields['Username'] = &$this->Username;

		// Password
		$this->Password = new ReportField('user_base', 'user', 'x_Password', 'Password', '`Password`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Password->Sortable = TRUE; // Allow sort
		$this->Password->DateFilter = "";
		$this->fields['Password'] = &$this->Password;

		// img
		$this->img = new ReportField('user_base', 'user', 'x_img', 'img', '`img`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
